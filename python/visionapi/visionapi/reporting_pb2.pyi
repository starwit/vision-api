...
class IncidentMessage(_message.Message):
    __slots__ = ("timestamp_utc_ms", "media_url", "model_info", "camera_location", "source_id")
    ...
    source_id: str
    def __init__(self, timestamp_utc_ms: _Optional[int] = ..., media_url: _Optional[str] = ..., model_info: _Optional[_Union[_common_pb2.ModelInfo, _Mapping]] = ..., camera_location: _Optional[_Union[_common_pb2.GeoCoordinate, _Mapping]] = ..., source_id: _Optional[str] = ...) -> None: ...
